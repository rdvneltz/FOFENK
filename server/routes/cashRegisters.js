...
router.get('/:id/transactions', async (req, res) => {
  try {
    ...
    // Add expenses as expense transactions (or income if isManualIncome)
    expenses.forEach(expense => {
      // Check if this is a manual income entry (bakiye ekleme)
      const isIncome = expense.isManualIncome === true || expense.category === 'Kasa Giriş (Manuel)';
