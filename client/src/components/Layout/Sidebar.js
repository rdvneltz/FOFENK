...
const allMenuItems = [
  ...
  { text: 'Deneme Dersleri', icon: <TrialIcon />, path: '/trial-lessons', permission: 'canManageTrialLessons' },
  ...
  { text: 'Kasa Yönetimi', icon: <CashIcon />, path: '/cash-registers', permission: 'canViewCashRegisters' },
